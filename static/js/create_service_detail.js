...
function update_page(new_html) {
    ...
    $('#service_detail_list').html(new_html)
}
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.errors) {
                ...
                $('#service_detail_form').html(response.html);
            }
        },
        error: function (xhr, status, error) {
            console.log('error =', error)
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.errors) {
                ...
                $('#service_detail_list').html(response.html);
            }
        },
        error: function (xhr, status, error) {
            console.log('error =', error)
